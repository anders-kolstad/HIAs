...
## Area explicit?
Ecosystem condition indicators designed for ecosystem accounting following the SEEA EA standard needs to be area explicit.
...
If Norwegian forests are delineated on a map, then this value is also delineated on a map, i.e. it's area explicit.
:::
:::
