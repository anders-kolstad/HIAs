...
I will now simulate som (national) data and some domain data and then test the functions for getting updated domain shape and variance.

I tried also with prior weight of 5, and results are qualitativly similar. As a rule of thumb, I want the posterior distribution to include just about the whole range for the national data when n = 2-3.
