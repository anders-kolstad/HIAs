...
# I will simulate som (national) data and some domain data
...
# unaffected by the national data.
# The uncertainty around the domain estimate will use information
# about the shape of the national data distribution. 
# This information will count the equivalent of 10 domain spesific values,
# thus making it possible to estimate domain distributions even with
# quite low n. I tried also with prior weight of 5, and results are qialitatively
# similar. As a rul of thumb, I want the posterior distribution to include
