...
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| Nordre Follo | `r terrestrial |> filter(Municipality == "Nordre Follo") |> pull(t_area_km)` | `r muni_tbl |> filter(Municipality == "Nordre Follo") |> pull(dk_percent)` |                                                     |                 |                                       |                                   |
| Trondheim    | `r terrestrial |> filter(Municipality == "Trondheim") |> pull(t_area_km)`    | `r muni_tbl |> filter(Municipality == "Trondheim") |> pull(dk_percent)`    |                                                     |                 |                                       |                                   |
| Målselv      | `r terrestrial |> filter(Municipality == "Målselv") |> pull(t_area_km)`      | `r muni_tbl |> filter(Municipality == "Målselv") |> pull(dk_percent)`      |                                                     |                 |                                       |                                   |
