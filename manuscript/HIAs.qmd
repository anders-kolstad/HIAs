...
# code to show all municipalities
#tm_shape(muni)+
#  tm_polygons(col="kommunenummer")+
#  tm_layout(legend.outside = T)

# Transform to match the EDM (see below)
muni <- muni |>
  st_transform(25832)

# subset of the three taregt municipalities
muni3 <- muni |>
...
# and also to get the dat coverage polygon
tm_shape(muni3)+
  tm_polygons()+
  tm_facets(by = "kommunenummer")+
  tm_shape(naturetypes)+
  tm_polygons()
```
