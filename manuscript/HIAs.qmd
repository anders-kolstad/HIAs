...
# I first tried to import and crop the mire data using starts, but that failed (se pre 21 feb 2023)
...
# Lets try discrete colors, and merge som classes to simplify
