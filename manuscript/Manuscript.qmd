...
This allows us to get a realistic picture of indicator uncertainty even sample sizes are very low.
...
The exception was for the variable *Trenching* in Nordre Follo, where the indicator value was 0.24; well below the threshold for good ecosystem condition (0.6).
...
However, Nordre Follo might be unique, and dissimilar, to the rest of Norway, and for that reason, the point estimate is kept independent of data from outside the municipality and reflecting only the local condition.
