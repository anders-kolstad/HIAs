...
In addition, we show how Bayesian updating can help produce reliable uncertainty estimates for condition indicators that suffer from low sampling sizes where traditional variances would be impossible.
...
We wich to thank Kwaku Peprah Adjei for statistical help, and Hanno Sandvik for code review.
