...
tempDF <- tibble(
  ...
  pop_uniform = runif(n, 0, 1),
  pop_normal_centered = rnorm(n, 0.5, 0.2),
  pop_normal_high = rnorm(n, 1, .5),
  pop_beta_2_2 = rbeta(n, 2, 2),
  pop_beta_05_3 = rbeta(n, .5, 3),
  pop_beta_3_05 = rbeta(n, 3, .5),
...
pop_uniform_para          <- EnvStats::ebeta(tempDF$pop_uniform)
pop_normal_centered_para <- EnvStats::ebeta(tempDF$pop_normal_centered)
pop_normal_high_para      <- EnvStats::ebeta(tempDF$pop_normal_high)
pop_beta_2_2_para         <- EnvStats::ebeta(tempDF$pop_beta_2_2)
pop_beta_05_3_para        <- EnvStats::ebeta(tempDF$pop_beta_05_3)
pop_beta_3_05_para        <- EnvStats::ebeta(tempDF$pop_beta_3_05)
...
PDs <-tibble(
    ...
    pd_normal_centered_1 = wgt_mean(tempDF$pop_normal_centered[1], 
      tempDF$wgt[1],
      shape1 = pop_normal_centered_para$parameters["shape1"],
      shape2 = pop_normal_centered_para$parameters["shape2"])[1:100],
