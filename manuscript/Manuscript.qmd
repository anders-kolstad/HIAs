...
knitr::include_graphics("../output/fig/validation-plot.tiff")
```
...
knitr::include_graphics("../output/fig/forest-plot.tiff")
```
...
knitr::include_graphics("../output/fig/spread-na.tiff")
```
...
For a rendered version of the source file, with all code and calculation visible, see Appendix C. 

The source files and some of the data are located on GitHub (https://github.com/anders-kolstad/HIAs) with an archived stable version on Zenodo (doi:10.5281/zenodo.11504703).
