...
We aggregated this data to 1 × 1 km pixels; a grit which is sufficient for estimating precise area weighted means for municipalities, which is the main objective for this analysis.
The 1 × 1 km scale is too coarse, however, for the maps themselves to be very usefil in land-use management decitions, 
and perhaps also in municipal planning. 
This is intentional, since as the extrapolated indicator values we produce are not reliable enough to be used at that spatial scale.  
