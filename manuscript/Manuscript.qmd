---
title: Making use of patchy and spatially biased variables in ecosystem condition accounting
author:
...
Ecosystem accounts should ideally reflect conditions only inde the accounting area and are arguable more useful when reflecting local management and land use policies, unaffected by the actions of neighboring or ecologically similar administrative units.
...
In this study we present a stratified aggregation technique, using homogeneous impact areas, to leverage spatially biased field data in ecosystem condition accounting.
Further, we combine a requirement for making indicator point estimates using local data only with an empirical Bayes approach to small area estimation to borrow strength from a larger national dataset and make better prediction about shape and variance in the distribution of possible indicator values.
