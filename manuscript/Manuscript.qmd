...
Wall-to-wall raw data, such as satellite imagery, is spatially representative though the property of being spatailly exhaustive, although of coarse the grain size also plays a role.
...
Here we focus in data with a bias in the environmetal space.
...
1.  Look-up table
2.  Spatial interpolation (e.g. inverse distanse weighting)
...
How values are assigned to strata varies a lot, including expert opinion and nummeric aggregation of data (e.g. the mean of all the data that fall in the same strata).
