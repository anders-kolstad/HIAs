...
Using Bayesian updating, we incorporate uncertainty estimates, whilst accomodating scarce data sets.
...
This study makes use of a data set of nature types occurence in Norway [@norwegian_environmental_agency_naturtyper_2024], surveyed using a shared protocol [@norwegian_environmental_agency_protocol].
Selected nature types are delineated on a map (over 140 000 polygons at the end of 2023), and each locality is scored on a range of variables relevant for describing the state and quality of nature.
...
To turn variables into indicators [sensu @unitednations2024] we scaled them using three reference levels each: an upper (best possible condition; X~100~), a lower (worst possible condition; X~0~), and X~60~ defining the breaking point between good and poor condition \[@jakobsson2020\].
The nomeclature follows @czúcz.
...
The variable 7FA was normalised into the indicator named *Alien species*; 7GR-GI was normalised into the indicator *Trenching*; and ADSV was normalised and kept the name *ADSV* (Figure S1).
For *Alien species* and *ADSV*, X~0~ and X~100~ was defined as 100% and 0%, respectively, whereas X~60~ was defined as 10%, thus making a piece-wise linear transformation (Figure S2).
For *Trenching* we defined X~0~ and X~100~ as 1 and 5, respectively, and X~60~ as 2.5 (Figure S2).
